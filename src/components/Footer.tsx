            ...
            <div className="lg:col-span-2 space-y-3 sm:space-y-4">
              ...
              <div className="flex flex-col space-y-2 sm:space-y-3">
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2.5 sm:gap-3 text-xs sm:text-sm text-brand-cream hover:text-brand-orange transition-colors py-0.5 group"
                  aria-label="Follow Trivandrum Capitals on Facebook"
                >
                  <div className="w-8 h-8 rounded bg-[#1877F2] flex items-center justify-center shrink-0 shadow-md transform group-hover:scale-110 transition-transform">
                    <FacebookIcon size={16} className="text-white" />
                  </div>
                  <span className="font-medium group-hover:text-brand-yellow transition-colors">Facebook</span>
                </a>
                <a
                  ...
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2.5 sm:gap-3 text-xs sm:text-sm text-brand-cream hover:text-brand-orange transition-colors py-0.5 group"
                  aria-label="Watch Trivandrum Capitals on YouTube"
                >
                  <div className="w-8 h-8 rounded bg-[#FF0000] flex items-center justify-center shrink-0 shadow-md transform group-hover:scale-110 transition-transform">
                    <YouTubeIcon size={16} className="text-white" />
                  </div>
                  <span className="font-medium group-hover:text-brand-yellow transition-colors">YouTube</span>
                </a>
              </div>
            </div>
