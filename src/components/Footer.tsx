    ...
    <footer id="contact" className="bg-gradient-to-b from-brand-dark via-[#021730] to-brand-dark text-brand-cream border-t-4 border-brand-orange relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 sm:pt-16 pb-10 sm:pb-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 sm:gap-12 lg:gap-8 mb-12 sm:mb-16">
          ...
          <div className="lg:col-span-2 space-y-3 sm:space-y-4">
            ...
            <div className="flex flex-col space-y-3">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-3 text-sm text-brand-cream hover:text-brand-orange transition-colors py-0.5"
              >
          ...
          <div className="lg:col-span-3 bg-brand-blue/15 border-2 border-brand-blue/40 p-5 sm:p-6 space-y-4">
        ...
        <div className="pt-6 sm:pt-8 border-t border-brand-blue/30 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-brand-cream/70">
          <div className="flex items-center gap-2">
