...
export default function ClubSection() {
  return (
    <section id="club" className="py-16 sm:py-20 lg:py-32 bg-brand-dark relative overflow-hidden court-overlay">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 space-y-5 sm:space-y-6 lg:sticky lg:top-32">
            <div className="flex items-center gap-3">
              ...
              <span className="h-0.5 w-10 sm:w-12 bg-brand-orange shrink-0" />
            ...
            <p className="text-base sm:text-lg text-brand-cream/80 leading-relaxed font-normal border-l-2 border-brand-blue/50 pl-4">
              {clubConfig.description}
            </p>

            <div className="p-5 sm:p-6 bg-brand-blue/15 border-2 border-brand-blue/40 relative">
              ...
              <p className="font-display text-lg sm:text-xl tracking-wide text-brand-yellow uppercase mb-2">
          ...
          <div className="lg:col-span-7 space-y-6 sm:space-y-8">
            <div className="border-b border-brand-blue/40 pb-3 sm:pb-4">
            ...
            <div className="space-y-4 sm:space-y-6">
              {clubConfig.principles.map((principle, index) => (
                <div
                  key={index}
                  className="group p-5 sm:p-8 bg-brand-dark/90 border-2 border-brand-blue/30 hover:border-brand-orange transition-all duration-300 relative"
                >
                  <div className="absolute top-0 left-0 w-1.5 sm:w-2 h-full bg-brand-blue group-hover:bg-brand-orange transition-colors" />

                  <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                    <div className="space-y-2 sm:space-y-3 flex-1 pl-3 sm:pl-4">
                      <div className="flex items-center gap-3">
