  ...
  return (
    <section className="bg-brand-blue/20 border-y border-brand-blue/40 relative z-20 shadow-xl overflow-hidden">
      <div className="site-container">
        ...
        <div className="flex flex-col sm:hidden divide-y divide-brand-blue/30 py-1">
        ...
        {/* Tablet/Desktop layout: horizontal row (640px+) */}
        <div className="hidden sm:flex sm:items-center justify-between gap-6 py-4 lg:py-5">
          ...
          <div className="flex items-center gap-6 lg:gap-10 flex-1 min-w-0">
            ...
            <div className="flex items-center gap-3 shrink-0">
              ...
              <div>
                ...
                <div className="font-display text-base lg:text-lg text-brand-yellow flex items-center gap-2">
                  <span className="w-2 h-2 rounded-full bg-green-500 animate-ping inline-block shrink-0" />
            ...
            {/* Item 2 */}
            <div className="flex items-center gap-3 border-l border-brand-blue/40 pl-6 shrink-0">
              <div className="w-10 h-10 bg-brand-blue/20 border border-brand-blue text-brand-cream flex items-center justify-center shrink-0">
                <MapPin size={18} />
              </div>
              <div>
                <div className="status-label text-brand-cream/70">Location</div>
                <div className="font-display text-base lg:text-lg text-brand-cream">{trialStatus.location}</div>
              </div>
            </div>

            {/* Item 3 */}
            <div className="flex items-center gap-3 border-l border-brand-blue/40 pl-6 min-w-0">
              <div className="w-10 h-10 bg-brand-yellow/20 border border-brand-yellow text-brand-yellow flex items-center justify-center shrink-0">
                <Users size={18} />
              </div>
              <div className="min-w-0">
                <div className="status-label text-brand-cream/70">Categories</div>
                <div className="font-display text-base lg:text-lg text-brand-cream truncate">{trialStatus.categories}</div>
              </div>
            </div>
          </div>
